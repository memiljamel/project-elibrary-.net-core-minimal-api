...
namespace ELibrary.Validators
{
    public class CreateStaffValidator : AbstractValidator<CreateStaffRequest>
    {
        ...
        private bool IsUsernameUnique(CreateStaffRequest request, string username)
        {
            return _unitOfWork.StaffRepository.IsUsernameUnique(username, null);
        }

        private bool IsStaffNumberUnique(CreateStaffRequest request, string staffNumber)
        {
